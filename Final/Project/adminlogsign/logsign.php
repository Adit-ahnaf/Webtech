...
<html lang="en">
          ...
          <form action="loginsert.php" class="sign-in-form" method="POST"  onsubmit="return validate()">
            ...
            <div class="input-field">
             ...
             <div class="input-field">
              ...
              <input type="admincode" name="acode" id="acode" placeholder="Admin code" />
              <span id="adcode" class="text-danger"> </span>
            </div>
  ...
  function validate(){
        ...
        var Admincode = document.getElementById('acode').value;
        ...
        if(Admincode == "") {
          document.getElementById('abcode').innerHTML = "Plese fill up the field";
  ...
  ?>
          ...
          <form action="insert.php" class="sign-up-form" method="POST"  onsubmit="return validation()" >
            ...
            <div class="input-field">
             ...
             <div class="input-field">
              <i class="fas fa-shield-alt"></i>
              <input type="Admincode" name="Admincode" id="Admincode" placeholder="Admin code" />
              <span id="code"> </span>
            </div>
  ...
  function validation(){
        ...
        if(Admincode == "") {
          document.getElementById('code').innerHTML = "Plese fill up the field";
